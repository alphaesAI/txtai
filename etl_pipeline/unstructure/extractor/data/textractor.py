...
class Textractor(Segmentation):
    ...
    def batch_extract(self, data):
        """
        Batch process data from preprocessor output.
        
        Args:
            data: Dictionary with "files", "html", and "text" keys
